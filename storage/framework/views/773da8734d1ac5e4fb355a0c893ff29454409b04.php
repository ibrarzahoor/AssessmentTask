...
<body class="text-center">
    <main class="form-signin">
        <form id="registration-form" action="<?php echo e(route('auth.register')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            registerButton.addEventListener('click', function () {
                ...
                registrationForm.action = '<?php echo e(route('login')); ?>';
...
<?php /**PATH C:\Users\Ibrar Zahoor\Desktop\laravel\auth-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>